...
export default function SignInForm({onHandleSubmit}:any) {
    const labelStyle = "pb-3 text-md font-medium";
    const InputStyle = "rounded border border-zinc-700 py-1 px-2 mb-6";
    return (
        <form action={onHandleSubmit} className="border border-zinc-800 flex flex-col rounded-2xl p-6 bg-[#171717]">
